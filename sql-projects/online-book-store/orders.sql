...
INSERT INTO `orders` (`Order_ID`, `Customer_ID`, `Book_ID`, `Order_Date`, `Quantity`, `Total_Amount`) VALUES
    ...
    ('10', '94', '122', '2024-07-09', '4', '123.0'),
    ('11', '131', '206', '2023-10-16', '1', '38.01'),
    ('12', '454', '3', '2024-06-17', '2', '31.5'),
    ...
    ('31', '386', '279', '2024-03-12', '8', '244.0'),
    ('32', '292', '313', '2024-12-06', '4', '188.64'),
    ('33', '478', '253', '2024-04-15', '5', '58.3'),
    ('34', '463', '146', '2024-06-27', '3', '43.5'),
    ('35', '303', '172', '2023-07-08', '5', '184.1'),
    ('36', '417', '260', '2024-01-21', '9', '446.31'),
    ('37', '110', '411', '2023-12-27', '4', '60.12'),
    ('38', '15', '466', '2023-06-26', '4', '148.68'),
    ('39', '488', '422', '2024-08-03', '8', '367.28'),
    ('40', '120', '450', '2024-07-03', '2', '91.5'),
    ('41', '418', '147', '2024-05-05', '8', '361.6'),
    ...
    ('108', '281', '430', '2024-05-25', '6', '71.4'),
    ('109', '486', '368', '2024-11-19', '2', '89.2'),
    ...
    ('124', '272', '122', '2024-05-17', '10', '307.5'),
    ...
    ('168', '324', '36', '2023-01-11', '10', '345.1'),
    ('169', '81', '415', '2024-02-04', '10', '295.1'),
    ('170', '121', '77', '2023-05-06', '10', '442.8'),
    ('171', '364', '397', '2023-01-12', '10', '281.5'),
    ...
    ('249', '131', '189', '2023-01-15', '8', '109.2'),
    ('250', '63', '65', '2023-09-16', '9', '204.3'),
    ('251', '109', '490', '2023-12-12', '2', '25.76'),
    ('252', '405', '387', '2023-11-15', '5', '237.1'),
    ('253', '449', '273', '2023-01-03', '3', '37.29'),
    ('254', '99', '469', '2023-07-18', '2', '46.5'),
    ...
    ('295', '414', '269', '2024-10-07', '5', '165.4'),
    ('296', '181', '486', '2023-09-13', '1', '19.13'),
    ('297', '382', '381', '2024-07-27', '4', '42.4'),
    ('298', '359', '73', '2024-08-22', '10', '212.3'),
    ...
    ('312', '209', '208', '2023-04-23', '10', '250.0'),
    ...
    ('317', '400', '88', '2023-01-06', '10', '402.2'),
    ...
    ('330', '265', '65', '2023-01-10', '10', '227.0'),
    ...
    ('396', '59', '424', '2023-04-09', '6', '243.0'),
    ('397', '368', '73', '2023-01-19', '6', '127.38'),
    ('398', '273', '334', '2023-07-21', '9', '321.12'),
    ('399', '318', '393', '2022-12-27', '9', '396.0'),
    ('400', '239', '33', '2024-04-05', '10', '350.6'),
    ('401', '154', '475', '2023-12-06', '1', '47.76'),
    ('402', '199', '323', '2022-12-25', '8', '286.64'),
    ('403', '98', '398', '2024-11-17', '10', '334.1'),
    ('404', '457', '191', '2024-10-02', '10', '421.9'),
    ('405', '405', '149', '2024-05-01', '5', '85.45'),
    ('406', '438', '78', '2023-02-17', '10', '130.7'),
    ...
    ('411', '486', '208', '2023-10-29', '8', '200.0'),
    ...
    ('421', '56', '183', '2023-04-01', '5', '77.0'),
    ('422', '322', '176', '2023-12-25', '8', '128.88'),
    ('423', '11', '349', '2024-01-10', '5', '221.8'),
    ('424', '291', '118', '2024-01-16', '7', '38.64'),
    ('425', '98', '308', '2023-02-14', '6', '124.5'),
    ('426', '98', '33', '2024-02-18', '5', '175.3'),
    ('427', '287', '434', '2023-09-11', '7', '319.06'),
    ('428', '214', '175', '2023-02-16', '10', '328.5'),
    ('429', '449', '146', '2023-11-01', '7', '101.5'),
    ('430', '206', '26', '2024-07-26', '2', '42.1'),
    ('431', '68', '276', '2024-09-22', '1', '19.85'),
    ('432', '420', '168', '2023-11-04', '3', '42.39'),
    ('433', '37', '223', '2023-03-01', '6', '39.12'),
    ('434', '45', '83', '2023-10-20', '10', '89.4'),
    ('435', '13', '230', '2023-04-14', '8', '48.8'),
    ...
    ('443', '425', '108', '2024-04-30', '10', '253.8'),
    ...
    ('451', '87', '307', '2023-08-04', '10', '144.3'),
    ...
    ('457', '387', '147', '2024-03-17', '10', '452.0'),
    ...
    ('475', '284', '161', '2023-03-02', '7', '151.2'),
    ('476', '387', '379', '2023-04-02', '5', '28.5'),
    ('477', '162', '454', '2023-05-30', '7', '66.92'),
    ('478', '423', '350', '2024-08-02', '4', '126.68'),
    ('479', '328', '197', '2023-12-26', '7', '301.21'),
    ('480', '415', '146', '2023-06-21', '7', '101.5'),
    ('481', '405', '353', '2023-07-07', '10', '469.7'),
    ('482', '2', '429', '2024-08-31', '7', '298.06'),
    ('483', '459', '202', '2023-11-23', '10', '122.6'),
    ('484', '500', '274', '2023-08-31', '6', '292.8'),
    ('485', '140', '230', '2023-02-04', '5', '30.5'),
    ('486', '322', '110', '2023-04-26', '2', '60.3'),
    ('487', '102', '245', '2023-12-23', '7', '112.42'),
    ('488', '47', '18', '2023-05-23', '4', '157.88'),
    ('489', '211', '471', '2023-02-22', '5', '226.9'),
    ...
    ('495', '216', '497', '2023-03-31', '3', '72.3'),
    ('496', '53', '233', '2024-09-28', '6', '62.34'),
    ('497', '328', '272', '2023-04-25', '10', '51.6'),
    ('498', '152', '406', '2024-03-10', '2', '71.58'),
    ('499', '140', '48', '2023-08-26', '1', '24.7'),
